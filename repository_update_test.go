...
var _ = Describe("Repository", func() {
	...
	Describe("Log", func() {
		It("should log with extra fields if log is supported", func() {
			...
			metricsMock.EXPECT().Record(gomock.Any(), metricsModel.OpUpdate, key, gomock.Any(), &err)
	...
	Describe("Metrics", func() {
		It("should record metrics if metric is supported", func() {
			...
			repository.WithMetrics(metricsMock)
			metricsMock.EXPECT().Record(gomock.Any(), metricsModel.OpUpdate, key, gomock.Any(), gomock.Eq(new(error)))

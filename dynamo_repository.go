...
func (repository Repository) GetItemWithContext(ctx context.Context, key KeyInterface, item interface{}) (bool, error) {
	var err error
	defer repository.recordMetrics(ctx, OpRead, key, err == nil)()
...
func (repository Repository) SaveItemWithContext(ctx context.Context, key KeyInterface, item interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, OpCommit, key, err == nil)()
...
func (repository Repository) UpdateWithContext(ctx context.Context, expression UpdateExpression, key KeyInterface, values map[string]interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, OpUpdate, key, err == nil)()
...
func (repository Repository) DeleteItemWithContext(ctx context.Context, key KeyInterface) error {
	var err error
	defer repository.recordMetrics(ctx, OpDelete, key, err == nil)()
...
func (repository Repository) DeleteItemsWithContext(ctx context.Context, keys []KeyInterface) error {
	var err error
	defer repository.recordMultipleMetrics(ctx, OpDelete, keys, err == nil)()
...
func (repository Repository) QueryWithContext(ctx context.Context, query QueryInterface, item interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, OpRead, query, err == nil)()
...
func (repository Repository) BatchGetItemsWithContext(ctx context.Context, keys []KeyInterface, out interface{}) (bool, error) {
	var err error
	defer repository.recordMultipleMetrics(ctx, OpRead, keys, err == nil)()
...
func (repository Repository) recordMetrics(ctx context.Context, caller string, key KeyInterface, success bool) func() {
	start := time.Now()
	return func() {
		repository.metrics.Record(ctx, caller, key, time.Since(start), success)
	}
}

func (repository Repository) recordMultipleMetrics(ctx context.Context, caller string, keys []KeyInterface, success bool) func() {
	start := time.Now()
	return func() {
		duration := time.Since(start)
		for _, key := range keys {
			repository.metrics.Record(ctx, caller, key, duration, success)
		}
	}
}

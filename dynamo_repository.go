...
func NewRepository(dynamoClient dynamodbiface.DynamoDBAPI) RepositoryInterface {
	return &Repository{
		...
		log:          logger.NewNopLog(),
	}
}

// WithLog enables logging; it accepts LogInterface as logger
func (repository *Repository) WithLog(log logger.LogInterface) {
	repository.log = log
}

// WithMetrics enables metrics; it accepts MetricsInterface as metrics publisher
func (repository *Repository) WithMetrics(metricsInterface metrics.MetricsInterface) {
...
func (repository *Repository) GetItemWithContext(ctx context.Context, key model.Key, item interface{}) (bool, error) {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpRead, key, &err)()
...
func (repository *Repository) SaveItemWithContext(ctx context.Context, key model.Key, item interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpCommit, key, &err)()
...
// returns error in case of error
func (repository *Repository) UpdateWithContext(ctx context.Context, expression UpdateExpression, key model.Key, values map[string]interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpUpdate, key, &err)()
...
// returns error in case of error
func (repository *Repository) DeleteItemWithContext(ctx context.Context, key model.Key) error {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpDelete, key, &err)()
...
// returns error in case of error
func (repository *Repository) SaveItemsWithContext(ctx context.Context, key model.Key, items interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpCommit, key, &err)()
...
// returns error in case of error
func (repository *Repository) DeleteItemsWithContext(ctx context.Context, keys []model.Key) error {
	var err error
	defer repository.recordMultipleMetrics(ctx, metricsModel.OpDelete, keys, &err)()
...
func (repository *Repository) GetItemsWithContext(ctx context.Context, key model.Key, items interface{}) (bool, error) {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpRead, key, &err)()
...
func (repository *Repository) QueryWithContext(ctx context.Context, query QueryInterface, item interface{}) error {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpRead, query, &err)()
...
func (repository *Repository) OptimisticLockSaveWithContext(ctx context.Context, key model.Key, item interface{}) (bool, error) {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpCommit, key, &err)()
...
func (repository *Repository) ConditionalUpdateWithContext(ctx context.Context, key model.Key, item interface{}, expression string, expressionArgs ...interface{}) (bool, error) {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpUpdate, key, &err)()
...
func (repository *Repository) ScanIteratorWithContext(ctx context.Context, key model.Key, searchLimit int64) (IteratorInterface, error) {
	var err error
	defer repository.recordMetrics(ctx, metricsModel.OpRead, key, &err)()
...
func (repository *Repository) BatchGetItemsWithContext(ctx context.Context, keys []model.Key, out interface{}) (bool, error) {
	var err error
	defer repository.recordMultipleMetrics(ctx, metricsModel.OpRead, keys, &err)()
...
func (repository *Repository) recordMetrics(ctx context.Context, caller string, key model.Key, err *error) func() {
	start := time.Now()
	return func() {
		if err != nil && *err != nil {
			repository.log.WithContext(ctx).WithField(TableName, key.TableName()).Error((*err).Error())
		}

		repository.metrics.Record(ctx, caller, key, time.Since(start), err)
	}
}

func (repository *Repository) recordMultipleMetrics(ctx context.Context, caller string, keys []model.Key, err *error) func() {
	start := time.Now()
	return func() {
		duration := time.Since(start)
		if err != nil && *err != nil && len(keys) != 0 {
			repository.log.WithContext(ctx).WithField(TableName, keys[0].TableName()).Error((*err).Error())
		}
		for _, key := range keys {
			repository.metrics.Record(ctx, caller, key, duration, err)
		}
	}
}
